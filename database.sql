...
CREATE TABLE ADMIN (
 user_id VARCHAR(36) PRIMARY KEY FOREIGN KEY REFERENCES
USER_ACCOUNT(user_id) ON DELETE CASCADE,
...
CREATE TABLE COURSE_CLASS (
 ...
 class_id VARCHAR(20) FOREIGN KEY REFERENCES CLASS(class_id),
 lecturer_id VARCHAR(20) FOREIGN KEY REFERENCES
...
CREATE TABLE GRADE (
 ...
 course_class_id VARCHAR(60) FOREIGN KEY REFERENCES
...
'8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92',
'Lecturer', 1);
INSERT INTO LECTURER (user_id, lecturer_id, full_name, position, email,
phone) VALUES
...
INSERT INTO CLASS (class_id, class_name, faculty, total_students)
VALUES
('CNTT-01', 'Information Tech 1', 'IT', 20),
('LOG-01', 'Logistics 1', 'Transport', 0);
INSERT INTO COURSE_CLASS (course_class_id, class_id, lecturer_id,
subject_name, semester) VALUES
...
INSERT INTO STUDENT (user_id, student_id, full_name, gender, email,
phone, address, class_id) VALUES
('S1', 'SV26001', 'Nguyen Van Anh', 'Male', 'sv1@ut.edu.vn', '0912001',
'HCM', 'CNTT-01'),
('S2', 'SV26002', 'Tran Thi Binh', 'Female', 'sv2@ut.edu.vn',
'0912002', 'HCM', 'CNTT-01'),
('S3', 'SV26003', 'Le Khanh Cuong', 'Male', 'sv3@ut.edu.vn', '0912003',
'HCM', 'CNTT-01'),
('S4', 'SV26004', 'Pham Thuy Dung', 'Female', 'sv4@ut.edu.vn',
'0912004', 'HCM', 'CNTT-01'),
('S5', 'SV26005', 'Hoang Trong An', 'Male', 'sv5@ut.edu.vn', '0912005',
'HCM', 'CNTT-01'),
('S6', 'SV26006', 'Vu Thi Cuc', 'Female', 'sv6@ut.edu.vn', '0912006',
'HCM', 'CNTT-01'),
('S7', 'SV26007', 'Bui Van Dat', 'Male', 'sv7@ut.edu.vn', '0912007',
'HCM', 'CNTT-01'),
('S8', 'SV26008', 'Dang Thi Hoa', 'Female', 'sv8@ut.edu.vn', '0912008',
'HCM', 'CNTT-01'),
('S9', 'SV26009', 'Doan Khac Hung', 'Male', 'sv9@ut.edu.vn', '0912009',
'HCM', 'CNTT-01'),
('S10', 'SV26010', 'Ngo Thuy Linh', 'Female', 'sv10@ut.edu.vn',
'0912010', 'HCM', 'CNTT-01'),
('S11', 'SV26011', 'Ly Hoang Nam', 'Male', 'sv11@ut.edu.vn', '0912011',
'HCM', 'CNTT-01'),
('S12', 'SV26012', 'Vuong Thi Nga', 'Female', 'sv12@ut.edu.vn',
'0912012', 'HCM', 'CNTT-01'),
('S13', 'SV26013', 'Phan Thanh Phat', 'Male', 'sv13@ut.edu.vn',
'0912013', 'HCM', 'CNTT-01'),
('S14', 'SV26014', 'Trinh Quoc Quan', 'Female', 'sv14@ut.edu.vn',
'0912014', 'HCM', 'CNTT-01'),
('S15', 'SV26015', 'Dao Thi Quynh', 'Male', 'sv15@ut.edu.vn',
'0912015', 'HCM', 'CNTT-01'),
('S16', 'SV26016', 'Duong Ngoc Sang', 'Female', 'sv16@ut.edu.vn',
'0912016', 'HCM', 'CNTT-01'),
('S17', 'SV26017', 'Mai Thanh Thao', 'Male', 'sv17@ut.edu.vn',
'0912017', 'HCM', 'CNTT-01'),
('S18', 'SV26018', 'Dinh Van Tuan', 'Female', 'sv18@ut.edu.vn',
'0912018', 'HCM', 'CNTT-01'),
('S19', 'SV26019', 'Chau Nhu Uyen', 'Male', 'sv19@ut.edu.vn',
'0912019', 'HCM', 'CNTT-01'),
('S20', 'SV26020', 'Lai Quoc Viet', 'Female', 'sv20@ut.edu.vn',
'0912020', 'HCM', 'CNTT-01');
-- F. Dữ liệu Điểm học phần (Môn CS101 và CS102)
INSERT INTO GRADE (grade_id, student_id, course_class_id,
attendance_grade, midterm_grade, final_grade, total_grade) VALUES
