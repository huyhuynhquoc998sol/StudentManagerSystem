...
class Student:
    def __init__(self, sid, name, gender, cid, phone, email, address=""):
        self.student_id = sid; self.full_name = name; self.gender = gender
        self.class_id = cid; self.phone = phone; self.email = email; self.address = address
